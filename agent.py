# Making of the agent that handles queries that need both data sources sequentially.
import json
import re
import logging
...
# Using basic logging for better visibility into agent operations
...
def run_agent(
    ...
    try:
        ...
        if chat_history:
            # Only include valid history entries that have role and content
        ...
        while iteration < max_iterations:
            ...
            # Break once we have a valid answer or if we've exhausted iterations
            break
